    ...
    *,
    ...
    source_candidate_records = [
        {
            ...
            "first_semantic_role": item.first_semantic_role,
            "second_semantic_role": item.second_semantic_role,
            "first_is_fu_negation_proxy": item.first_is_fu_negation_proxy,
            "second_is_fu_negation_proxy": item.second_is_fu_negation_proxy,
    ...
    return {
        ...
        "coverage_boundary": {
            ...
            "source_hcs_marker_proxy": "latest prior supplied Casino A/F physical marker directional wick + exact OHLC intersection",
            "source_hcs_marker_proxy_same_direction_required": False,
            "source_hcs_marker_proxy_fu_negation_integrated": True,
            "source_hcs_marker_proxy_fu_negation_role_is_proxy_only": True,
            "source_hcs_marker_proxy_double_counts_strong_negation_physical_node": False,
